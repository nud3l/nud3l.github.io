...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Hi! I'm Dominik "Dom" Harz. I am a software engineer and researcher. I am passionate about building systems that are secure, scalable, and accessible. I am currently working on Bitcoin DeFi infrastructure at <a href="https://interlay.io">Interlay</a>.
        <br />      
